...
<head>
      ...
      <meta name="author" content="Vishal Kurniawan">

      <title>Ndorobei Racing Solution</title>
...
<body>
      ...
      <div class="container">
            ...
            <div class="row">
                  <div class="col-lg-12">
                        <h1 class="page-header" style="color:#FF432E;">Welcome to
                              Ndorobei Racing Solution Apps
                        </h1>
                  </div>
            </div>
            <!-- /.row -->
